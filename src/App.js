import "./App.css";
// let image = require("../assets/images/image-web-3-desktop.jpg");
let image = require("./assets/images/image-1.jpg");
let image3 = require("./assets/images/image-gaming-growth.jpg");
let retropc = require("./assets/images/image-2.jpg");
let image2 = require("./assets/images/image-top-laptops.jpg");
...
function App() {
  return (
    <div className="App">
      ...
      <div className="container">
        <div className="child1">
          <img src={image} alt="image not found" className="desktopImg1" />
          <div className="childofchild1">
            <div style={{width:'54%',marginLeft:'0%'}}><p style={{ fontSize:'40px', fontWeight: "bolder"}}>
              The Bright
              <br /> Future of
              <br /> Web 3.0?
            </p></div>
            <div style={{width:'44%', paddingLeft:'50px'}} ><p style={{fontSize:'12px' ,lineHeight:'20px'}}>
              We dive into the next evolution of the web that claims to put the
              power of the platforms back into the hands of the people. But is
              it really fulfilling its promise?<br/><br/> <br/><div style={{backgroundColor:'#f15d51',color:'white',height:'20px', width:'100px', fontSize:'12px', textAlign:'center' , padding:'10px', fontWeight:'bold',letterSpacing:'2px'}}>READ MORE</div>
            </p></div>
          </div>
        </div>
        ...
        <div className="child2">
          <div className="content">
            <h1 style={{ marginLeft: "5px", color: "orange" }}>New</h1>

            <h4>Hydrogen VS Electric Cars</h4>
            <p style={{ lineHeight: "22px", color:'#88899e' }}>
              Will hydrogen-fueled cars ever catch up to EVs?
            </p>
            <hr style={{ borderTop: " 0em solid grey" }}></hr>
    ...
    <img src={retropc} alt="image not found" className="retropc" />
    </div>
    </div>
  );
}
